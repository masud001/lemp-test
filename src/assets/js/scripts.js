...
import "./fakeLoader.min.js";
import "./jquery.waypoints.min.js";
import "./gijgo.min.js";
import "./file-upload.js";
import "./auotline-editor.js";
// import "./retina.min.jss";
...
(function($) {
    ...
    $(function(){
        ...
        $(document).ready(function() {
          ...
          //used for main page date menu

        // $('#datetimepicker1').timepicker({
        //     format: 'LT
        // });
        $('#timepicker1, #timepicker3, #timepicker5, #timepicker7, #timepicker9').timepicker();
        $('#timepicker2, #timepicker4, #timepicker6, #timepicker8, #timepicker10').timepicker();          
        ...
        var $headerContainer = $('.testimonial');
        var $withoutTestimoanlHeader = $('.without-testimonial');
        var $popupContainer = $('.map-popup-design');

        $(window).on('scroll', function(){
            
            if($(window).scrollTop() >= 15){
                $headerContainer.addClass('sticking');
                $popupContainer.addClass('move');
            } 
            else {
                $headerContainer.removeClass('sticking');
                $popupContainer.removeClass('move');
            }
            
            $withoutTestimoanlHeader.addClass('sticking');
        }).scroll();

        // var $imgSection = $('#img-section');
        // $(window).on('scroll', function(){
        //     if($(window).scrollTop() >= 15){
        //         $imgSection.addClass('dis-block');
        //         $imgSection.removeClass('dis-none');
        //     } 
        //     else {
        //         $imgSection.addClass('dis-none');
        //         $imgSection.removeClass('dis-block');
        //     }
        // }).scroll();
